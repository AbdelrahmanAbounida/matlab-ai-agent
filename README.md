...
Navigate to your MATLAB installation's Python engine directory and run:
```bash
python -m pip install .
```

Default paths (for example):
- **Windows:** `C:\Program Files\MATLAB\R2024b\extern\engines\python`
- **macOS:** `/Applications/MATLAB_R2024b.app/extern/engines/python`
- **Linux:** `/usr/local/MATLAB/R2024b/extern/engines/python`
